...
adminlist = {"ADD YOUR NAME HERE"}--Add in the names of the people you want to be able to use the command script here.
...
text("You're an admin.",5,"Message",ack.PlayerGui)
return
end
